...
import { createApp } from '../../../payment-orchestration-service/src/app.ts';
import type { ServiceContainer } from '../../../payment-orchestration-service/src/container.ts';
import type { PaymentOrchestrationServiceConfig } from '../../../payment-orchestration-service/src/config/env.ts';
import { CreateMerchant } from '../../../payment-orchestration-service/src/application/use-cases/CreateMerchant.ts';
import { CreateProviderAccount } from '../../../payment-orchestration-service/src/application/use-cases/CreateProviderAccount.ts';
import { CreatePaymentIntent } from '../../../payment-orchestration-service/src/application/use-cases/CreatePaymentIntent.ts';
import { CreateGatewayPayment } from '../../../payment-orchestration-service/src/application/use-cases/CreateGatewayPayment.ts';
import { ConfirmFakeGatewayPayment } from '../../../payment-orchestration-service/src/application/use-cases/ConfirmFakeGatewayPayment.ts';
...
import { ReconcilePaymentIntentTotals } from '../../../payment-orchestration-service/src/application/use-cases/ReconcilePaymentIntentTotals.ts';
...
function buildContainer(
  ...
  const fakeGatewayProvider = new StandaloneFakeGatewayProvider(nodeEnv);
