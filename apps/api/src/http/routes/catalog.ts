...
router.post('/products', requireManager, CatalogController.createOrUpdateProduct);
...
router.put('/products/:id', requireManager, CatalogController.createOrUpdateProduct);
...
router.post('/categories', requireManager, CategoryController.createCategory);
// PATCH /api/catalog/categories - Rename category (bulk update products)
router.patch('/categories', requireManager, CategoryController.renameCategory);
// DELETE /api/catalog/categories - Delete category by moving products to fallback
router.delete('/categories', requireManager, CategoryController.deleteCategory);
// PUT /api/catalog/categories/reorder - Reorder categories by id sequence
router.put('/categories/reorder', requireManager, CategoryController.reorderCategories);
